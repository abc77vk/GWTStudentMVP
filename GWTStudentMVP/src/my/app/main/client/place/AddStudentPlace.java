 ...
 *******************************************************************************/
package my.app.main.client.place;
 ...
 */
public class AddStudentPlace extends Place {
	...
	public AddStudentPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<AddStudentPlace> {

		@Override
		public String getToken(AddStudentPlace place) {
			return place.getName();
		}

		@Override
		public AddStudentPlace getPlace(String token) {
			return new AddStudentPlace(token);
		}
