 ...
 */
public class ShowMarksPlace extends Place {
	...
	public ShowMarksPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<ShowMarksPlace> {

		@Override
		public String getToken(ShowMarksPlace place) {
			return place.getName();
		}

		@Override
		public ShowMarksPlace getPlace(String token) {
			return new ShowMarksPlace(token);
		}
